---
name: prompt2repo
description: "Prompt2Repo 一键入口: 从 prompt.md 到完整交付包的全自动流水线，串联 Phase 0-4.5 + 打包后三轮复部署测试门禁"
---
...
本 Skill 是 Prompt2Repo 的**统一入口**，串联 Phase 0-4.5，实现从 Prompt 到可交付产物的一次执行全自动化，并在打包后执行三轮复部署测试门禁。
...
phases:
  ...
  - name: "artifact-truth-gate"
    ...
    skippable: false
    prompt: "强制校验 post-package 报告与 TASK 包真实目录一致（必须存在 repo/unit_tests 与 repo/API_tests），并拦截 PASS 但矛盾文本，输出 .tmp/artifact-truth-gate.md。"
